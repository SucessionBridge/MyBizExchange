    ...
    <>
      ...
      <div className="md:hidden">
        <div className="relative -mx-4 px-4">
          {/* Put gradients behind cards so borders/rings are visible */}
                ...
                <Link key={listing.id} href={`/listings/${listing.id}`}>
                  <a
                    ...
                    className="
                      ...
                      ring-1 ring-gray-300 ring-offset-2 ring-offset-white
                      md:border md:border-gray-200 md:shadow-none md:ring-0 md:ring-offset-0
