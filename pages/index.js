    ...
    <main className="min-h-screen bg-blue-800 text-white p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-semibold mb-4 text-yellow-400">What is Your Business Worth?</h2>
          ...
          <div className="flex justify-center mb-8">
            <Link href="/business-valuation">
              <button className="bg-orange-600 text-white py-3 px-6 rounded-lg hover:bg-orange-700 text-lg font-semibold transition-all duration-300">
        ...
        {/* Sellers Section */}
        <div className="text-center mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">Are You a Seller?</h2>
          ...
          <div className="flex justify-center mb-4">
            <Link href="/sellers">
              <button className="bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 text-lg font-semibold transition-all duration-300">
                List Your Business
              </button>
            </Link>
          </div>
        ...
        {/* Buyers Section */}
        <div className="text-center mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">Are You a Buyer?</h2>
          <p className="text-lg mb-6 text-gray-300">
          ...
          <div className="flex justify-center mb-4">
            <Link href="/buyers">
              <button className="bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 text-lg font-semibold transition-all duration-300">
                Browse Businesses
              </button>
            </Link>
          </div>
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-semibold mb-4 text-white">How SuccessionBridge Works</h2>
          <p className="text-lg mb-6 text-gray-300">
