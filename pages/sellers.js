...
export default function SellerWizard() {
  ...
  const renderPreview = () => (
    <div className="bg-white rounded shadow p-6 space-y-6">
      ...
      {imagePreviews.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
          {imagePreviews.map((src, idx) => (
            <img key={idx} src={src} className="w-full h-48 object-cover rounded border" />
          ))}
        </div>
      )}

      <div className="grid md:grid-cols-2 gap-6 text-gray-800 mt-4">
        <div>
          <h3 className="text-lg font-semibold border-b pb-1 mb-2">Financial Overview</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold border-b pb-1 mb-2">Business Info</h3>
      ...
      <div>
        <h3 className="text-lg font-semibold border-b pb-1 mb-2">Business Description</h3>
        <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">{formData.businessDescription || 'No description provided.'}</p>
      </div>

      {formData.aiDescription && (
        <div>
          <h3 className="text-lg font-semibold border-b pb-1 mb-2">AI-Enhanced Summary</h3>
          <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">{formData.aiDescription}</p>
        </div>
      )}

      <div className="grid md:grid-cols-2 gap-6 text-gray-800">
        <div>
          <h3 className="text-lg font-semibold border-b pb-1 mb-2">Customer Insights</h3>
        ...
        <div>
          <h3 className="text-lg font-semibold border-b pb-1 mb-2">Owner Reflections</h3>
          <p><strong>Proud of:</strong> {formData.proudOf}</p>
