        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/sellers">
                <a className="inline-flex items-center justify-center rounded-xl bg-[#F59E0B] hover:bg-[#D97706] text-white px-5 py-3 text-base font-semibold focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#F59E0B]">
                  Start a Listing
                </a>
              </Link>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 shadow-sm">
            ...
            {submitted ? (
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-4" noValidate>
                {/* Honeypot */}
                <input type="text" name="website" value={form.website} onChange={onChange} className="hidden" />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.name}
                    onChange={onChange}
                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-[#14B8A6]"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={onChange}
                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-[#14B8A6]"
                    placeholder="Tell us a bit about your business, timeline, and goals..."
                  />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center justify-center rounded-xl bg-[#14B8A6] hover:bg-[#0D9488] disabled:opacity-60 text-white px-5 py-3 text-base font-semibold focus:ring-2 focus:ring-offset-2 focus:ring-[#14B8A6]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center rounded-xl bg-[#2E3A59] hover:opacity-95 text-white px-5 py-3 text-base font-semibold focus:ring-2 focus:ring-offset-2 focus:ring-[#2E3A59]"
                  >
                    Or Book a Call
                  </a>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 md:p-8 shadow-sm">
              ...
              <div className="mt-6">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center rounded-lg bg-[#14B8A6] hover:bg-[#0D9488] text-white px-4 py-2 font-semibold"
                >
                  Book a 15-min Intro
                </a>
              </div>
