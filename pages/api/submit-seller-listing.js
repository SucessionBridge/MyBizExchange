...
const { error } = await supabase.from('sellers').insert([
  {
    ...
    annual_revenue: Number(fields.annualRevenue?.[0] || 0),
    annual_profit: Number(fields.annualProfit?.[0] || 0),
    sde: Number(fields.sde?.[0] || 0),
    asking_price: Number(fields.askingPrice?.[0] || 0),
    employees: parseInt(fields.employees?.[0]) || 0,
    monthly_lease: Number(fields.monthly_lease?.[0] || 0),
    inventory_value: Number(fields.inventory_value?.[0] || 0),
    equipment_value: Number(fields.equipment_value?.[0] || 0),
    ...
    image_urls: imageUrls, // already handled
  },
]);
